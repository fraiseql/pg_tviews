...
// Manually register the pg_tviews_convert_table function
// This is needed because pgrx may not auto-discover it from the event_trigger module
extension_sql!(
    r"
    ...
    ",
    name = "register_convert_function",
