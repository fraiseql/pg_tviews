...
BEGIN
    ...
    PERFORM public.record_benchmark('ecommerce', 'bulk_update', 'medium', 'tviews_jsonb_ivm', 100, 1, v_duration_ms);
...
BEGIN
    ...
    PERFORM public.record_benchmark('ecommerce', 'bulk_1k', 'medium', 'tviews_jsonb_ivm', 1000, 1, v_duration_ms);
